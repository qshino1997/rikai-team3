...
class HistoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create history" do
    assert_difference('History.count') do
      post histories_url, params: { history: { book_id: @history.book_id, indentify_id: @history.indentify_id, mode: @history.mode, user_id: @history.user_id } }
    end
  ...
  test "should update history" do
    patch history_url(@history), params: { history: { book_id: @history.book_id, indentify_id: @history.indentify_id, mode: @history.mode, user_id: @history.user_id } }
